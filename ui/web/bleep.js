...
/*!***************************************************!*\
  !*** ./src/sequence_editor/module_units/index.js ***!
  \***************************************************/
/*! exports provided: Pulse, PlayNote, SequenceInput, Range, Factory */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _factory_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./factory.js */ "./src/sequence_editor/module_units/factory.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Factory", function() { return _factory_js__WEBPACK_IMPORTED_MODULE_4__["Factory"]; });
...
class Sequence extends _model___WEBPACK_IMPORTED_MODULE_0__["Patchable"] {
  ...
  loadSequence(sequenceDef, input) {
    if (sequenceDef["before"]) { // we filter out before, because this is handled in the timeline
      ...
      var g = new _module_units___WEBPACK_IMPORTED_MODULE_1__["PlayNote"]();
...
class Channel {
  ...
  initialiseSequenceTracks(sequences) {
    ...
    for (var s of sequences) {
      ...
      var track = new _sequence_track_js__WEBPACK_IMPORTED_MODULE_0__["SequenceTrack"](s);
...
class SequenceTrack {
  constructor(sequence_def) {
    ...
    this.sequence = new _sequence_editor_sequence_js__WEBPACK_IMPORTED_MODULE_0__["Sequence"]()
